...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=<?php echo get_theme_mod('def_wp_typography_header'); ?>&display=swap">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=<?php echo get_theme_mod('def_wp_typography_body'); ?>&display=swap">
	<?php wp_head(); ?>
    <style>
        body {
            font-family: '<?php echo get_theme_mod('def_wp_typography_body'); ?>', sans-serif !important;
            font-size: <?php echo get_theme_mod('def_wp_typography_body_size'); ?>px !important;
            color: <?php echo get_theme_mod('def_wp_typography_body_color'); ?> !important;
        }
        h1, h2, h3, h4, h5, h6 {
            font-family: '<?php echo get_theme_mod('def_wp_typography_header'); ?>', sans-serif !important;
        }
    </style>
</head>
...
<?php do_action( 'boilerplate_site_before' ); ?>

<div id="page" class="min-h-screen flex flex-col">

	<?php do_action( 'boilerplate_header' ); ?>
	...
	<div id="content" class="site-content flex-grow">
		...
		<?php do_action( 'boilerplate_content_start' ); ?>
